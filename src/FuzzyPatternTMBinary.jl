...
mutable struct TATeam <: AbstractTATeam
    ...
    function TATeam(clause_size::Int64, clauses_num::Int64, include_limit::Int64, state_min::Int64, state_max::Int64)
        ...
        positive_included_literals = fill([], clauses_num)
        negative_included_literals = fill([], clauses_num)
        positive_included_literals_inverted = fill([], clauses_num)
        negative_included_literals_inverted = fill([], clauses_num)
