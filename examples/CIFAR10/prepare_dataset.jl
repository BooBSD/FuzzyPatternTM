...
function bools(rawR, x3R, y3R, x5R, y5R, x7R, y7R, x9R, y9R, rawG, x3G, y3G, x5G, y5G, x7G, y7G, x9G, y9G, rawB, x3B, y3B, x5B, y5B, x7B, y7B, x9B, y9B)
    raw_hist_25R::Float64 = quantile([x for x in rawR if x > 0], 0.25)
    raw_hist_50R::Float64 = quantile([x for x in rawR if x > 0], 0.50)
    raw_hist_75R::Float64= quantile([x for x in rawR if x > 0], 0.75)

    x3_hist_pos_25R::Float64 = quantile([x for x in x3R if x > 0], 0.25)
    x3_hist_pos_34R::Float64 = quantile([x for x in x3R if x > 0], 0.34)
    x3_hist_pos_50R::Float64 = quantile([x for x in x3R if x > 0], 0.50)
    x3_hist_pos_75R::Float64 = quantile([x for x in x3R if x > 0], 0.75)
    x3_hist_neg_25R::Float64 = quantile([x for x in x3R if x < 0], 1 - 0.25)
    x3_hist_neg_34R::Float64 = quantile([x for x in x3R if x < 0], 1 - 0.34)
    x3_hist_neg_50R::Float64 = quantile([x for x in x3R if x < 0], 1 - 0.50)
    x3_hist_neg_75R::Float64 = quantile([x for x in x3R if x < 0], 1 - 0.75)

    y3_hist_pos_25R::Float64 = quantile([x for x in y3R if x > 0], 0.25)
    y3_hist_pos_34R::Float64 = quantile([x for x in y3R if x > 0], 0.34)
    y3_hist_pos_50R::Float64 = quantile([x for x in y3R if x > 0], 0.50)
    y3_hist_pos_75R::Float64 = quantile([x for x in y3R if x > 0], 0.75)
    y3_hist_neg_25R::Float64 = quantile([x for x in y3R if x < 0], 1 - 0.25)
    y3_hist_neg_34R::Float64 = quantile([x for x in y3R if x < 0], 1 - 0.34)
    y3_hist_neg_50R::Float64 = quantile([x for x in y3R if x < 0], 1 - 0.50)
    y3_hist_neg_75R::Float64 = quantile([x for x in y3R if x < 0], 1 - 0.75)

    x5_hist_pos_25R::Float64 = quantile([x for x in x5R if x > 0], 0.25)
    x5_hist_pos_34R::Float64 = quantile([x for x in x5R if x > 0], 0.34)
    x5_hist_pos_50R::Float64 = quantile([x for x in x5R if x > 0], 0.50)
    x5_hist_pos_75R::Float64 = quantile([x for x in x5R if x > 0], 0.75)
    x5_hist_neg_25R::Float64 = quantile([x for x in x5R if x < 0], 1 - 0.25)
    x5_hist_neg_34R::Float64 = quantile([x for x in x5R if x < 0], 1 - 0.34)
    x5_hist_neg_50R::Float64 = quantile([x for x in x5R if x < 0], 1 - 0.50)
    x5_hist_neg_75R::Float64 = quantile([x for x in x5R if x < 0], 1 - 0.75)

    y5_hist_pos_25R::Float64 = quantile([x for x in y5R if x > 0], 0.25)
    y5_hist_pos_34R::Float64 = quantile([x for x in y5R if x > 0], 0.34)
    y5_hist_pos_50R::Float64 = quantile([x for x in y5R if x > 0], 0.50)
    y5_hist_pos_75R::Float64 = quantile([x for x in y5R if x > 0], 0.75)
    y5_hist_neg_25R::Float64 = quantile([x for x in y5R if x < 0], 1 - 0.25)
    y5_hist_neg_34R::Float64 = quantile([x for x in y5R if x < 0], 1 - 0.34)
    y5_hist_neg_50R::Float64 = quantile([x for x in y5R if x < 0], 1 - 0.50)
    y5_hist_neg_75R::Float64 = quantile([x for x in y5R if x < 0], 1 - 0.75)

    x7_hist_pos_25R::Float64 = quantile([x for x in x7R if x > 0], 0.25)
    x7_hist_pos_34R::Float64 = quantile([x for x in x7R if x > 0], 0.34)
    x7_hist_pos_50R::Float64 = quantile([x for x in x7R if x > 0], 0.50)
    x7_hist_pos_75R::Float64 = quantile([x for x in x7R if x > 0], 0.75)
    x7_hist_neg_25R::Float64 = quantile([x for x in x7R if x < 0], 1 - 0.25)
    x7_hist_neg_34R::Float64 = quantile([x for x in x7R if x < 0], 1 - 0.34)
    x7_hist_neg_50R::Float64 = quantile([x for x in x7R if x < 0], 1 - 0.50)
    x7_hist_neg_75R::Float64 = quantile([x for x in x7R if x < 0], 1 - 0.75)

    y7_hist_pos_25R::Float64 = quantile([x for x in y7R if x > 0], 0.25)
    y7_hist_pos_34R::Float64 = quantile([x for x in y7R if x > 0], 0.34)
    y7_hist_pos_50R::Float64 = quantile([x for x in y7R if x > 0], 0.50)
    y7_hist_pos_75R::Float64 = quantile([x for x in y7R if x > 0], 0.75)
    y7_hist_neg_25R::Float64 = quantile([x for x in y7R if x < 0], 1 - 0.25)
    y7_hist_neg_34R::Float64 = quantile([x for x in y7R if x < 0], 1 - 0.34)
    y7_hist_neg_50R::Float64 = quantile([x for x in y7R if x < 0], 1 - 0.50)
    y7_hist_neg_75R::Float64 = quantile([x for x in y7R if x < 0], 1 - 0.75)

    x9_hist_pos_25R::Float64 = quantile([x for x in x9R if x > 0], 0.25)
    x9_hist_pos_34R::Float64 = quantile([x for x in x9R if x > 0], 0.34)
    x9_hist_pos_50R::Float64 = quantile([x for x in x9R if x > 0], 0.50)
    x9_hist_pos_75R::Float64 = quantile([x for x in x9R if x > 0], 0.75)
    x9_hist_neg_25R::Float64 = quantile([x for x in x9R if x < 0], 1 - 0.25)
    x9_hist_neg_34R::Float64 = quantile([x for x in x9R if x < 0], 1 - 0.34)
    x9_hist_neg_50R::Float64 = quantile([x for x in x9R if x < 0], 1 - 0.50)
    x9_hist_neg_75R::Float64 = quantile([x for x in x9R if x < 0], 1 - 0.75)

    y9_hist_pos_25R::Float64 = quantile([x for x in y9R if x > 0], 0.25)
    y9_hist_pos_34R::Float64 = quantile([x for x in y9R if x > 0], 0.34)
    y9_hist_pos_50R::Float64 = quantile([x for x in y9R if x > 0], 0.50)
    y9_hist_pos_75R::Float64 = quantile([x for x in y9R if x > 0], 0.75)
    y9_hist_neg_25R::Float64 = quantile([x for x in y9R if x < 0], 1 - 0.25)
    y9_hist_neg_34R::Float64 = quantile([x for x in y9R if x < 0], 1 - 0.34)
    y9_hist_neg_50R::Float64 = quantile([x for x in y9R if x < 0], 1 - 0.50)
    y9_hist_neg_75R::Float64 = quantile([x for x in y9R if x < 0], 1 - 0.75)


    raw_hist_25G::Float64 = quantile([x for x in rawG if x > 0], 0.25)
    raw_hist_50G::Float64 = quantile([x for x in rawG if x > 0], 0.50)
    raw_hist_75G::Float64= quantile([x for x in rawG if x > 0], 0.75)

    x3_hist_pos_25G::Float64 = quantile([x for x in x3G if x > 0], 0.25)
    x3_hist_pos_34G::Float64 = quantile([x for x in x3G if x > 0], 0.34)
    x3_hist_pos_50G::Float64 = quantile([x for x in x3G if x > 0], 0.50)
    x3_hist_pos_75G::Float64 = quantile([x for x in x3G if x > 0], 0.75)
    x3_hist_neg_25G::Float64 = quantile([x for x in x3G if x < 0], 1 - 0.25)
    x3_hist_neg_34G::Float64 = quantile([x for x in x3G if x < 0], 1 - 0.34)
    x3_hist_neg_50G::Float64 = quantile([x for x in x3G if x < 0], 1 - 0.50)
    x3_hist_neg_75G::Float64 = quantile([x for x in x3G if x < 0], 1 - 0.75)

    y3_hist_pos_25G::Float64 = quantile([x for x in y3G if x > 0], 0.25)
    y3_hist_pos_34G::Float64 = quantile([x for x in y3G if x > 0], 0.34)
    y3_hist_pos_50G::Float64 = quantile([x for x in y3G if x > 0], 0.50)
    y3_hist_pos_75G::Float64 = quantile([x for x in y3G if x > 0], 0.75)
    y3_hist_neg_25G::Float64 = quantile([x for x in y3G if x < 0], 1 - 0.25)
    y3_hist_neg_34G::Float64 = quantile([x for x in y3G if x < 0], 1 - 0.34)
    y3_hist_neg_50G::Float64 = quantile([x for x in y3G if x < 0], 1 - 0.50)
    y3_hist_neg_75G::Float64 = quantile([x for x in y3G if x < 0], 1 - 0.75)

    x5_hist_pos_25G::Float64 = quantile([x for x in x5G if x > 0], 0.25)
    x5_hist_pos_34G::Float64 = quantile([x for x in x5G if x > 0], 0.34)
    x5_hist_pos_50G::Float64 = quantile([x for x in x5G if x > 0], 0.50)
    x5_hist_pos_75G::Float64 = quantile([x for x in x5G if x > 0], 0.75)
    x5_hist_neg_25G::Float64 = quantile([x for x in x5G if x < 0], 1 - 0.25)
    x5_hist_neg_34G::Float64 = quantile([x for x in x5G if x < 0], 1 - 0.34)
    x5_hist_neg_50G::Float64 = quantile([x for x in x5G if x < 0], 1 - 0.50)
    x5_hist_neg_75G::Float64 = quantile([x for x in x5G if x < 0], 1 - 0.75)

    y5_hist_pos_25G::Float64 = quantile([x for x in y5G if x > 0], 0.25)
    y5_hist_pos_34G::Float64 = quantile([x for x in y5G if x > 0], 0.34)
    y5_hist_pos_50G::Float64 = quantile([x for x in y5G if x > 0], 0.50)
    y5_hist_pos_75G::Float64 = quantile([x for x in y5G if x > 0], 0.75)
    y5_hist_neg_25G::Float64 = quantile([x for x in y5G if x < 0], 1 - 0.25)
    y5_hist_neg_34G::Float64 = quantile([x for x in y5G if x < 0], 1 - 0.34)
    y5_hist_neg_50G::Float64 = quantile([x for x in y5G if x < 0], 1 - 0.50)
    y5_hist_neg_75G::Float64 = quantile([x for x in y5G if x < 0], 1 - 0.75)

    x7_hist_pos_25G::Float64 = quantile([x for x in x7G if x > 0], 0.25)
    x7_hist_pos_34G::Float64 = quantile([x for x in x7G if x > 0], 0.34)
    x7_hist_pos_50G::Float64 = quantile([x for x in x7G if x > 0], 0.50)
    x7_hist_pos_75G::Float64 = quantile([x for x in x7G if x > 0], 0.75)
    x7_hist_neg_25G::Float64 = quantile([x for x in x7G if x < 0], 1 - 0.25)
    x7_hist_neg_34G::Float64 = quantile([x for x in x7G if x < 0], 1 - 0.34)
    x7_hist_neg_50G::Float64 = quantile([x for x in x7G if x < 0], 1 - 0.50)
    x7_hist_neg_75G::Float64 = quantile([x for x in x7G if x < 0], 1 - 0.75)

    y7_hist_pos_25G::Float64 = quantile([x for x in y7G if x > 0], 0.25)
    y7_hist_pos_34G::Float64 = quantile([x for x in y7G if x > 0], 0.34)
    y7_hist_pos_50G::Float64 = quantile([x for x in y7G if x > 0], 0.50)
    y7_hist_pos_75G::Float64 = quantile([x for x in y7G if x > 0], 0.75)
    y7_hist_neg_25G::Float64 = quantile([x for x in y7G if x < 0], 1 - 0.25)
    y7_hist_neg_34G::Float64 = quantile([x for x in y7G if x < 0], 1 - 0.34)
    y7_hist_neg_50G::Float64 = quantile([x for x in y7G if x < 0], 1 - 0.50)
    y7_hist_neg_75G::Float64 = quantile([x for x in y7G if x < 0], 1 - 0.75)

    x9_hist_pos_25G::Float64 = quantile([x for x in x9G if x > 0], 0.25)
    x9_hist_pos_34G::Float64 = quantile([x for x in x9G if x > 0], 0.34)
    x9_hist_pos_50G::Float64 = quantile([x for x in x9G if x > 0], 0.50)
    x9_hist_pos_75G::Float64 = quantile([x for x in x9G if x > 0], 0.75)
    x9_hist_neg_25G::Float64 = quantile([x for x in x9G if x < 0], 1 - 0.25)
    x9_hist_neg_34G::Float64 = quantile([x for x in x9G if x < 0], 1 - 0.34)
    x9_hist_neg_50G::Float64 = quantile([x for x in x9G if x < 0], 1 - 0.50)
    x9_hist_neg_75G::Float64 = quantile([x for x in x9G if x < 0], 1 - 0.75)

    y9_hist_pos_25G::Float64 = quantile([x for x in y9G if x > 0], 0.25)
    y9_hist_pos_34G::Float64 = quantile([x for x in y9G if x > 0], 0.34)
    y9_hist_pos_50G::Float64 = quantile([x for x in y9G if x > 0], 0.50)
    y9_hist_pos_75G::Float64 = quantile([x for x in y9G if x > 0], 0.75)
    y9_hist_neg_25G::Float64 = quantile([x for x in y9G if x < 0], 1 - 0.25)
    y9_hist_neg_34G::Float64 = quantile([x for x in y9G if x < 0], 1 - 0.34)
    y9_hist_neg_50G::Float64 = quantile([x for x in y9G if x < 0], 1 - 0.50)
    y9_hist_neg_75G::Float64 = quantile([x for x in y9G if x < 0], 1 - 0.75)


    raw_hist_25B::Float64 = quantile([x for x in rawB if x > 0], 0.25)
    raw_hist_50B::Float64 = quantile([x for x in rawB if x > 0], 0.50)
    raw_hist_75B::Float64= quantile([x for x in rawB if x > 0], 0.75)

    x3_hist_pos_25B::Float64 = quantile([x for x in x3B if x > 0], 0.25)
    x3_hist_pos_34B::Float64 = quantile([x for x in x3B if x > 0], 0.34)
    x3_hist_pos_50B::Float64 = quantile([x for x in x3B if x > 0], 0.50)
    x3_hist_pos_75B::Float64 = quantile([x for x in x3B if x > 0], 0.75)
    x3_hist_neg_25B::Float64 = quantile([x for x in x3B if x < 0], 1 - 0.25)
    x3_hist_neg_34B::Float64 = quantile([x for x in x3B if x < 0], 1 - 0.34)
    x3_hist_neg_50B::Float64 = quantile([x for x in x3B if x < 0], 1 - 0.50)
    x3_hist_neg_75B::Float64 = quantile([x for x in x3B if x < 0], 1 - 0.75)

    y3_hist_pos_25B::Float64 = quantile([x for x in y3B if x > 0], 0.25)
    y3_hist_pos_34B::Float64 = quantile([x for x in y3B if x > 0], 0.34)
    y3_hist_pos_50B::Float64 = quantile([x for x in y3B if x > 0], 0.50)
    y3_hist_pos_75B::Float64 = quantile([x for x in y3B if x > 0], 0.75)
    y3_hist_neg_25B::Float64 = quantile([x for x in y3B if x < 0], 1 - 0.25)
    y3_hist_neg_34B::Float64 = quantile([x for x in y3B if x < 0], 1 - 0.34)
    y3_hist_neg_50B::Float64 = quantile([x for x in y3B if x < 0], 1 - 0.50)
    y3_hist_neg_75B::Float64 = quantile([x for x in y3B if x < 0], 1 - 0.75)

    x5_hist_pos_25B::Float64 = quantile([x for x in x5B if x > 0], 0.25)
    x5_hist_pos_34B::Float64 = quantile([x for x in x5B if x > 0], 0.34)
    x5_hist_pos_50B::Float64 = quantile([x for x in x5B if x > 0], 0.50)
    x5_hist_pos_75B::Float64 = quantile([x for x in x5B if x > 0], 0.75)
    x5_hist_neg_25B::Float64 = quantile([x for x in x5B if x < 0], 1 - 0.25)
    x5_hist_neg_34B::Float64 = quantile([x for x in x5B if x < 0], 1 - 0.34)
    x5_hist_neg_50B::Float64 = quantile([x for x in x5B if x < 0], 1 - 0.50)
    x5_hist_neg_75B::Float64 = quantile([x for x in x5B if x < 0], 1 - 0.75)

    y5_hist_pos_25B::Float64 = quantile([x for x in y5B if x > 0], 0.25)
    y5_hist_pos_34B::Float64 = quantile([x for x in y5B if x > 0], 0.34)
    y5_hist_pos_50B::Float64 = quantile([x for x in y5B if x > 0], 0.50)
    y5_hist_pos_75B::Float64 = quantile([x for x in y5B if x > 0], 0.75)
    y5_hist_neg_25B::Float64 = quantile([x for x in y5B if x < 0], 1 - 0.25)
    y5_hist_neg_34B::Float64 = quantile([x for x in y5B if x < 0], 1 - 0.34)
    y5_hist_neg_50B::Float64 = quantile([x for x in y5B if x < 0], 1 - 0.50)
    y5_hist_neg_75B::Float64 = quantile([x for x in y5B if x < 0], 1 - 0.75)

    x7_hist_pos_25B::Float64 = quantile([x for x in x7B if x > 0], 0.25)
    x7_hist_pos_34B::Float64 = quantile([x for x in x7B if x > 0], 0.34)
    x7_hist_pos_50B::Float64 = quantile([x for x in x7B if x > 0], 0.50)
    x7_hist_pos_75B::Float64 = quantile([x for x in x7B if x > 0], 0.75)
    x7_hist_neg_25B::Float64 = quantile([x for x in x7B if x < 0], 1 - 0.25)
    x7_hist_neg_34B::Float64 = quantile([x for x in x7B if x < 0], 1 - 0.34)
    x7_hist_neg_50B::Float64 = quantile([x for x in x7B if x < 0], 1 - 0.50)
    x7_hist_neg_75B::Float64 = quantile([x for x in x7B if x < 0], 1 - 0.75)

    y7_hist_pos_25B::Float64 = quantile([x for x in y7B if x > 0], 0.25)
    y7_hist_pos_34B::Float64 = quantile([x for x in y7B if x > 0], 0.34)
    y7_hist_pos_50B::Float64 = quantile([x for x in y7B if x > 0], 0.50)
    y7_hist_pos_75B::Float64 = quantile([x for x in y7B if x > 0], 0.75)
    y7_hist_neg_25B::Float64 = quantile([x for x in y7B if x < 0], 1 - 0.25)
    y7_hist_neg_34B::Float64 = quantile([x for x in y7B if x < 0], 1 - 0.34)
    y7_hist_neg_50B::Float64 = quantile([x for x in y7B if x < 0], 1 - 0.50)
    y7_hist_neg_75B::Float64 = quantile([x for x in y7B if x < 0], 1 - 0.75)

    x9_hist_pos_25B::Float64 = quantile([x for x in x9B if x > 0], 0.25)
    x9_hist_pos_34B::Float64 = quantile([x for x in x9B if x > 0], 0.34)
    x9_hist_pos_50B::Float64 = quantile([x for x in x9B if x > 0], 0.50)
    x9_hist_pos_75B::Float64 = quantile([x for x in x9B if x > 0], 0.75)
    x9_hist_neg_25B::Float64 = quantile([x for x in x9B if x < 0], 1 - 0.25)
    x9_hist_neg_34B::Float64 = quantile([x for x in x9B if x < 0], 1 - 0.34)
    x9_hist_neg_50B::Float64 = quantile([x for x in x9B if x < 0], 1 - 0.50)
    x9_hist_neg_75B::Float64 = quantile([x for x in x9B if x < 0], 1 - 0.75)

    y9_hist_pos_25B::Float64 = quantile([x for x in y9B if x > 0], 0.25)
    y9_hist_pos_34B::Float64 = quantile([x for x in y9B if x > 0], 0.34)
    y9_hist_pos_50B::Float64 = quantile([x for x in y9B if x > 0], 0.50)
    y9_hist_pos_75B::Float64 = quantile([x for x in y9B if x > 0], 0.75)
    y9_hist_neg_25B::Float64 = quantile([x for x in y9B if x < 0], 1 - 0.25)
    y9_hist_neg_34B::Float64 = quantile([x for x in y9B if x < 0], 1 - 0.34)
    y9_hist_neg_50B::Float64 = quantile([x for x in y9B if x < 0], 1 - 0.50)
    y9_hist_neg_75B::Float64 = quantile([x for x in y9B if x < 0], 1 - 0.75)
