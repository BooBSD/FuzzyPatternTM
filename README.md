...
On the IMDb dataset, FPTM achieves **90.15%** accuracy with **only one clause per class**, a **50×** reduction in clauses and memory over the Weighted Coalesced Tsetlin Machine.
